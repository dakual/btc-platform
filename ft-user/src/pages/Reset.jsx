	          ...
	          <div className="card-body">
	            ...
	            <form method="POST" className="needs-validation" novalidate="" autocomplete="off">
	              <div className="mb-3">
	                ...
	                <input id="password" type="password" className="form-control" name="password" required autofocus />
	              ...
	              <div className="d-flex align-items-center">
	                <div className="form-check">
	                  ...
	                  <label for="logout" className="form-check-label">Logout all devices</label>
	                </div>
	                <button type="submit" className="btn btn-primary ms-auto"> Reset Password </button>
	              </div>
	            </form>
	          </div>
	        </div>
